...
YUVBASE="DF1000CLI"
MOV="../L_Full_HDR_UHD_2020_PQ_1000_PS4444_CLI/L_FullFeature_HDR_3840x2160_rec2020_PQ_1000nit_ProRes4444_24p_AppleCLI_VideoOnly.mov"


# Encode
crf=27

(ffmpeg -y -loglevel quiet -i $MOV\
   -an  -pix_fmt yuv420p10le -r 23.976 -f rawvideo -vcodec rawvideo - | x265 --input - \
...
WAV="../L_Full_HDR_UHD_2020_PQ_1000_PS4444_CLI/L_FullFeature_HDR_24p_51D_audio.wav"
ffmpeg -y -i $WAV -cutoff 18000 -ab 768k audio.aac
