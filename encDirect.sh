...
YUVBASE="Direct1000CLI"


# Encode
crf=12

(ffmpeg -y -i LS_5minClip_UHD_3840x2160_rec2020_PQ_1000nit_ProRes4444_24p_AppleCLI_VideoOnlyTest.mov \
...
ffmpeg -y -i LS_5minClip_51D_Audio_24p_48kHz_24bit.wav -acodec libfdk_aac -cutoff 18000 -ab 768k audio.aac
